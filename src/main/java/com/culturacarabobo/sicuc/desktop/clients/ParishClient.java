...
public class ParishClient {
    // Base URL for the parishes endpoint
    private static final String BASE_URL = EnvConfig.getApiUrl() + "/parishes";

    // Sends a GET request to retrieve parishes as a JSON string
    public static String getParishesJson() {
        try {
